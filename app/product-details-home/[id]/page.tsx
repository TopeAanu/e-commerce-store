// app/product-details-home/[id]/page.tsx
"use client";
...
const HomeGardenProductDetailsPage = ({ params }: ProductDetailsPageProps) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      try {
        ...
        const docRef = doc(db, "home", productId);
...
export default HomeGardenProductDetailsPage;
