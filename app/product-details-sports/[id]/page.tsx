// app/product-details-sports/[id]/page.tsx
"use client";
...
interface ProductDetailsSportsPageProps {
  params: Promise<{ id: string }>;
}

const ProductDetailsSportsPage = ({
  params,
}: ProductDetailsSportsPageProps) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      try {
        ...
        const docRef = doc(db, "sports", productId);
        ...
        if (docSnap.exists()) {
          ...
          const productsRef = collection(db, "sports");
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="text-sm text-gray-500 dark:text-gray-400 mb-2 capitalize">
                Sports & Outdoors •{" "}
                {product.description?.split(" - ")[1] || product.category}
              </div>
...
export default ProductDetailsSportsPage;
